...
#define OLED_PIN_1 GPIO_Pin_8
#define OLED_PIN_2 GPIO_Pin_9

// 引脚配置
#define OLED_W_SCL(x) GPIO_WriteBit(OLED_PORT, OLED_PIN_1, (BitAction)(x))
#define OLED_W_SDA(x) GPIO_WriteBit(OLED_PORT, OLED_PIN_2, (BitAction)(x))
...
void OLED_I2C_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = OLED_PIN_1;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = OLED_PIN_2;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
